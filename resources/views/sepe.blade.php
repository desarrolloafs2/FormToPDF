...
@section('content')
    ...
    <form id="form" class="my-5" method="POST" action="{{ url($type) }}">
                ...
                <div
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-12 mb-4">
                                ...
                                <input id="birthdate" type="date" name="birthdate" class="form-control"
                                    ...
                                    max="{{ Carbon::now()->subYears(16)->toDateString() }}" required>
                            </div>
                            <div class="col-lg-6 col-12 mb-4">
                                <label for="ssnumber" class="form-label">Nº de afiliación a la Seguridad Social*</label>
                                <input id="ssnumber" inputmode="numeric" type="text" pattern="[0-9]*"
                                    name="ssnumber" class="form-control" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 mb-4">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-12 mb-4">
                                ...
                                <select id="studyLevel" name="studyLevel" class="form-control">
                                    ...
                                    <option value="33">33 - Enseñanzas de Formación Profesional de Grado Medio.
                                    </option>
                                    ...
                                    <option value="51">51 - Enseñanzas de Formación Profesional de Grado Superior.
                                    </option>
                            ...
                            <div class="col-lg-6 col-12 mb-4">
                                ...
                                <select id="contributionGroup" name="contributionGroup" class="form-control" required>
                                    ...
                                    <option value="01">01 - Ingenieros y Licenciados. Personal de alta dirección no
                                        incluido
                                        en el artículo 1.3.c) del Estatuto de los Trabajadores.
                                    </option>
                                    <option value="02">02 - Ingenieros Técnicos, Peritos y Ayudantes titulados.
                                    </option>
                                    ...
                                    <option value="11">11 - Trabajadores menores de dieciocho años cualquiera que sea
                                        su
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12 mb-4">
                                <label for="cno" class="form-label">Ocupación* (Si está desempleado, indicar la
                                    última
                                    ocupación)</label>
                                <select id="cno" name="cno" class="form-control" required>
                                    ...
                                    <option value="1111">Miembros del poder ejecutivo (nacional, autonomico y local) y
                                        del
                                        poder legislativo
                                    </option>
                                    ...
                                    <option value="1315">Directores de empresas de abastecimiento, transporte,
                                        distribucion
                                        y afines
                                    </option>
                                    ...
                                    <option value="1327">Directores de sucursales de bancos, de servicios financieros y
                                        de
                                        seguros
                                    </option>
                                    ...
                                    <option value="1429">Directores y gerentes de empresas de catering y otras empresas
                                        de
                                        restauracion
                                    </option>
                                    <option value="1431">Directores y gerentes de empresas de comercio al por mayor
                                    </option>
                                    <option value="1432">Directores y gerentes de empresas de comercio al por menor
                                    </option>
                                    <option value="1501">Directores y gerentes de empresas de actividades recreativas,
                                        culturales y deportivas
                                    </option>
                                    <option value="1509">Directores y gerentes de empresas de gestion de residuos y de
                                        otras
                                    ...
                                    <option value="2158">Profesionales de la salud y la higiene laboral y ambiental
                                    </option>
                                    ...
                                    <option value="2220">Profesores de formacion profesional (materias especificas)
                                    </option>
                                    <option value="2230">Profesores de ensenanza secundaria (excepto materias especificas
                                        de
                                        formacion profesional)
                                    </option>
                                    ...
                                    <option value="2451">Arquitectos (excepto arquitectos paisajistas y urbanistas)
                                    </option>
                                    ...
                                    <option value="2469">Ingenieros tecnicos no clasificados bajo otros epigrafes
                                    </option>
                                    ...
                                    <option value="2821">Sociologos, geografos, antropologos, arqueologos y afines
                                    </option>
                                    ...
                                    <option value="3125">Tecnicos en electronica, especialidad en electromedicina
                                    </option>
                                    <option value="3126">Tecnicos en mecanica</option>
                                    <option value="3127">Tecnicos y analistas de laboratorio en quimica industrial
                                    </option>
                                    <option value="3128">Tecnicos en metalurgia y minas</option>
                                    <option value="3129">Otros tecnicos de las ciencias fisicas, quimicas,
                                        medioambientales
                                    ...
                                    <option value="3133">Tecnicos en control de instalaciones de procesamiento de
                                        productos
                                        quimicos
                                    </option>
                                    <option value="3134">Tecnicos de refinerias de petroleo y gas natural</option>
                                    <option value="3135">Tecnicos en control de procesos de produccion de metales
                                    </option>
                                    ...
                                    <option value="3160">Tecnicos de control de calidad de las ciencias fisicas, quimicas
                                        y
                                        de las ingenierias
                                    </option>
                                    ...
                                    <option value="3205">Supervisores de industrias de transformacion de plasticos,
                                        caucho y
                                        resinas naturales
                                    </option>
                                    <option value="3206">Supervisores de industrias de la madera y pastero papeleras
                                    </option>
                                    <option value="3207">Supervisores de la produccion en industrias de artes graficas y
                                        en
                                    ...
                                    <option value="3331">Profesionales de la acupuntura, la naturopatia, la homeopatia,
                                        la
                                    ...
                                    <option value="3539">Representantes artisticos y deportivos y otros agentes de
                                        servicios
                                    ...
                                    <option value="3623">Profesionales de apoyo de la Administracion Publica de servicios
                                        de
                                    ...
                                    <option value="3713">Profesionales de apoyo al trabajo y a la educacion social
                                    </option>
                                    ...
                                    <option value="3724">Monitores de actividades recreativas y de entretenimiento
                                    </option>
                                    ...
                                    <option value="3739">Otros tecnicos y profesionales de apoyo de actividades
                                        culturales y
                                        artisticas
                                    </option>
                                    ...
                                    <option value="4122">Empleados de oficina de servicios de apoyo a la produccion
                                    </option>
                                    ...
                                    <option value="5629">Trabajadores de los cuidados a las personas en servicios de
                                        salud
                                    ...
                                    <option value="6209">Trabajadores cualificados en actividades ganaderas no
                                        clasificados
                                        bajo otros epigrafes
                                    </option>
                                    ...
                                    <option value="7112">Montadores de prefabricados estructurales (solo hormigon)
                                    </option>
                                    <option value="7121">Albaniles</option>
                                    <option value="7122">Canteros, tronzadores, labrantes y grabadores de piedras
                                    </option>
                                    ...
                                    <option value="7295">Personal de limpieza de fachadas de edificios y chimeneas
                                    </option>
                                    ...
                                    <option value="7404">Mecanicos y ajustadores de maquinaria naval y ferroviaria
                                    </option>
                                    ...
                                    <option value="7533">Instaladores y reparadores en tecnologias de la informacion y
                                        las
                                        comunicaciones
                                    </option>
                                    <option value="7611">Relojeros y mecanicos de instrumentos de precision</option>
                                    <option value="7612">Lutieres y similares; afinadores de instrumentos musicales
                                    </option>
                                    ...
                                    <option value="7616">Rotulistas, grabadores de vidrio, pintores decorativos de
                                        articulos
                                        diversos
                                    </option>
                                    ...
                                    <option value="7618">Artesanos en tejidos, cueros y materiales similares,
                                        preparadores
                                    ...
                                    <option value="7704">Trabajadores del tratamiento de la leche y elaboracion de
                                        productos
                                        lacteos (incluidos helados)
                                    </option>
                                    <option value="7705">Trabajadores conserveros de frutas y hortalizas y trabajadores
                                        de
                                        la elaboracion de bebidas no alcoholicas
                                    </option>
                                    <option value="7706">Trabajadores de la elaboracion de bebidas alcoholicas distintas
                                        del
                                        vino
                                    </option>
                                    ...
                                    <option value="7899">Oficiales, operarios y artesanos de otros oficios no
                                        clasificados
                                        bajo otros epigrafes
                                    </option>
                                    ...
                                    <option value="8121">Operadores en instalaciones para la obtencion y transformacion
                                        de
                                        metales
                                    </option>
                                    <option value="8122">Operadores de maquinas pulidoras, galvanizadoras y recubridoras
                                        de
                                        metales
                                    </option>
                                    ...
                                    <option value="8144">Operadores de serrerias, de maquinas de fabricacion de tableros
                                        y
                                        de instalaciones afines para el tratamiento de la madera y el corcho
                                    </option>
                                    <option value="8145">Operadores en instalaciones para la preparacion de pasta de
                                        papel y
                                    ...
                                    <option value="8199">Operadores de instalaciones y maquinaria fijas no clasificados
                                        bajo
                                        otros epigrafes
                                    </option>
                                    ...
                                    <option value="8412">Conductores asalariados de automoviles, taxis y furgonetas
                                    </option>
                                    ...
                                    <option value="9210">Personal de limpieza de oficinas, hoteles y otros
                                        establecimientos
                                        similares
                                    </option>
                                    ...
                                    <option value="9442">Clasificadores de desechos, operarios de punto limpio y
                                        recogedores
                                        de chatarra
                                    </option>
                                    ...
                                    <option value="9812">Conductores de vehiculos de traccion animal para el transporte
                                        de
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-12 mb-4">
                                ...
                                <select id="professionalCategory" name="professionalCategory" class="form-control"
                                    required>
                                    <option disabled selected value="">Selecciona una categoría profesional</option>
                ...
                <div
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12 mb-4">
                                <label for="cif" class="form-label">CIF de la empresa donde trabaja
                                    actualmente*</label>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-12 mb-4">
                                ...
                                <select id="employmentRegime" name="employmentRegime" class="form-control">
                                    ...
                                    <option value="RERED">RERED - Trabajadores en ERTE afectados por Mecanismo RED
                                    </option>
                                    ...
                                    <option value="RLE">RLE - Trabajadores con relaciones laborales especiales según
                                        art. 2
                                        del Estatuto
                                    </option>
                                    <option value="CESS">CESS - Trabajadores con convenio especial con la Seguridad
                                        Social
                                    </option>
                                    ...
                                    <option value="OCTP">OCTP - Trabajadores ocupados con contrato a tiempo parcial
                                    </option>
                            ...
                            <div class="col-lg-6 col-12 mb-4">
                                ...
                                <select id="functionalArea" name="functionalArea" class="form-control">
        ...
        <div class="container-fluid">
            <div class="row">
                <div
                    class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-12 offset-0 px-lg-5 px-1 py-4 mb-4 rounded alert alert-info">
        ...
        <div class="text-center">
            <button id="submitBtn" type="submit" class="btn btn-secondary px-5 py-2"><strong>Enviar
