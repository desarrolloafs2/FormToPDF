                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select" id="actividad_empresa" name="actividad_empresa" required>
                                    <option value="">Selecciona</option>
                                    <option value="A - Agricultura, ganadería, pesca">A - Agricultura, ganadería, pesca
                                    </option>
                                    <option value="C - Industria">C - Industria</option>
                                    <option value="F - Construcción">F - Construcción</option>
                                    <option value="G - Comercio">G - Comercio</option>
                                    <option value="I - Hostelería">I - Hostelería</option>
                                    <option value="J - Información y comunicaciones">J - Información y comunicaciones
                                    </option>
                                    <option value="M - Actividades profesionales, científicas y técnicas">M - Actividades
                                        profesionales</option>
                                    <option value="S - Otros servicios">S. - Otros servicios</option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <label for="provincia_empresa" class="form-label">Provincia (empresa)</label>
                                <input type="text" class="form-control" id="provincia_empresa"
                                    name="provincia_empresa">
                            </div>
                            <div class="col-md-6 mb-4">
                                <label for="ccaa_empresa" class="form-label">CCAA (empresa)</label>
                                <input type="text" class="form-control" id="ccaa_empresa" name="ccaa_empresa">
                            </div>
                        </div>
