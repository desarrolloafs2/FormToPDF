...
return [
    ...
    'condiciones' => [
        'titulo' => 'CONDICIONADO GENERAL CURSO "GENERACIÓN DIGITAL PYMES"',
        'introduccion' => 'La superación de este programa financiado por el Plan de Recuperación, Transformación y Resiliencia, que imparte la entidad BUSINESS JUMP SL y, en consecuencia, la obtención del Título acreditativo del mismo, están sujetas al cumplimiento de la siguiente condición:',
        'puntos' => [
            'La asistencia a todas las sesiones lectivas del programa es obligatoria y se llevará registro de ella.',
            'El/la participante deberá asistir como mínimo al 75% de las horas de clase asignadas. En el caso de ausencia por enfermedad, accidente o cualquier otra causa justificada, el/la participante lo notificará a la entidad lo antes posible, aportando justificación.',
            'Además, ser APTO en las actividades complementarias establecidas para esta acción formativa, completando la visualización de al menos el 75% de los contenidos teóricos y al menos el 75% de los cuestionarios de autoevaluación.',
        ],
    ],

    // Checkboxes de declaraciones
    'checkboxes' => [
